...
export default function ToDoApp() {
  ...
  const addTask = () => {
    ...
    if (!trimmed) return Alert.alert('Attention', 'Please enter a task');
...
const removeTask = async (id) => {
  ...
  const clearCompleted = () => {
    Alert.alert('Clear Tasks', 'Remove all completed tasks?', [
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View style={styles.empty}><Text style={styles.emptyText}>No tasks yet</Text></View>
        )}
        style={styles.list}
      />
    </View>
